...
var _ = Describe("AS3Manager Tests", func() {
	...
	BeforeEach(func() {
		...
		resourceConfig = &ResourceConfig{
			...
			Virtual: Virtual{Name: "test-virtual-secure", Policies: []NameRef{}, Profiles: ProfileRefs{{Name: "clientssl", Partition: "Common", Context: "clientside"}, {Name: "serverssl", Partition: "Common", Context: "serverside"}}, PoolName: "test-pool", Partition: DEFAULT_PARTITION},
