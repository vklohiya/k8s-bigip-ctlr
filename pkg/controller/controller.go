...
func NewController(params Params) *Controller {
	...
	ctlr.initInformers()
	ctlr.RequestHandler.httpClientMetrics = params.httpClientMetrics
	...
	ctlr.NewRequestHandler(params.UserAgent)
...
func (ctlr *Controller) NewRequestHandler(userAgent string) {
