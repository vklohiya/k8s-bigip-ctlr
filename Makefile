...
local-go-coverage:
	go install -x github.com/Azure/gocover@latest
...
create-coverage-report: local-go-coverage
	go install -x github.com/axw/gocov/gocov@latest
	go install -x github.com/AlekSi/gocov-xml@latest
